...
---
## Role
Expose live equity/ETF quotes to the graph. This node ALWAYS runs (a no-llm AND-join branch of the
research region; not a skipped node). v2 upgrade (S11): the quote PATH is HC-1-backed
